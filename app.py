...
UUID = os.environ.get('UUID', 'de2ab7ea-5b1c-4612-8dd7-852137db2ba7')  
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', '')     
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')          
NEZHA_KEY = os.environ.get('NEZHA_KEY', '')           
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'streamlit0713.dfdrgtftd.eu.org')       
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiNTQxNjJiNmQ4OTY1NTVhOWFlY2Y0ZjRkMTEzNTU4OTYiLCJ0IjoiNDRhZDBmZGUtMjZmNS00ZDkwLTk4MGMtZjBjOTEwNmU0MGQ5IiwicyI6Ik1ESmlOREpoTURndFlUSmtOeTAwTW1RekxUazROMlV0TnpZd01qZzNNalZoTURKayJ9')            
ARGO_PORT = int(os.environ.get('ARGO_PORT', '8001'))   
CFIP = os.environ.get('CFIP', 'www.visa.com.tw')       
CFPORT = int(os.environ.get('CFPORT', '443'))         
NAME = os.environ.get('NAME', 'streamlitstreamlit0714')                   
